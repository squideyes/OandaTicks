...
namespace OandaTicks.Common.Helpers
{
    ...
    {
        public static void AddIfInvalid(this List<ValidationResult> results, 
            bool isValid, string fieldName, string format, params object[] args)
        {
            if (isValid)
                return;
            ...
            results.Add(new ValidationResult(
                $"The {fieldName} field must be set to {suffix}."));
        }
    }
}
